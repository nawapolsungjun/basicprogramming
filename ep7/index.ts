const database = [
 ...
 const deathMoreThanFive = database.filter(function (element, index) {
    return element.total_death > 5 && element.province !== 'ทั้งประเทศ'
 })
 
 const deathMoreThanFiveOnlyProvince = deathMoreThanFive.map(function (element, index) {
    return ({
       province: element.province,
       total_death: element.total_death
    })
 })
 console.log(deathMoreThanFiveOnlyProvince)